 ...
 *
 * things to try
 * https://stackoverflow.com/questions/50483874/how-can-i-know-whether-a-jobscheduler-is-running
 *
 *
 ...
 *
 *
 * ideal - rtc AlarmManager - Powermanager is bean used by Jobschedular
 *
 * https://stackoverflow.com/questions/38880969/what-tools-are-available-to-test-jobscheduler

 dumpsys jobscheduler
 adb shell dumpsys jobscheduler | grep  com.example.android.jobscheduler

 adb shell dumpsys activity service AlarmManager | grep com.example.android.jobscheduler

 If you use FirebaseJobDispatcher lib you can use

 adb shell dumpsys activity service GcmService | grep com.example.android.jobscheduler


 For example, your packagename is com.foo.bar.application and the JOB_ID was 1. You can now run your task via adb

 adb shell cmd jobscheduler run -f com.example.android.jobscheduler 1
 ...
 https://github.com/aosp-mirror/platform_frameworks_base/blob/master/services/core/java/com/android/server/job/JobSchedulerService.java
 ...
 //////// A  Question and solution on stack over flow
 ...
 ANS : jobs created with the same jobId will update the pre-existing job with the same id
 ...
 From API 24 (Nougat) you can use simple scheduler.getPendingJob(JOB_ID) != null
